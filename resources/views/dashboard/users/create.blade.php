    ...
    <form method="post" action="/register">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="is_admin" class="form-control rounded-top @error('is_admin')is-invalid @enderror" id="is_admin" placeholder="0 / 1" required value="{{ old('is_admin') }}">
            @error('is_admin')                          
            <div class="invalid-feedback">
                {{ $message }}
            </div>
          ...
          <button class="w-100 btn btn-lg btn-primary mt-3" type="submit">Create User</button>
    </form>
</div>
